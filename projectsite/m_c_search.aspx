<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="m_c_search.aspx.cs" Inherits="m_c" %>
...
<body>
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
            <ItemTemplate>
               <table class="table">
                                <tr>
                                    <td>
  <asp:Label ID="hospital_nameLabel" runat="server" Text='<%# Eval("med_cent_name") %>' />
 </td>
                                    <td>
                                        <h4>
                                ...
                                <tr>
                                    <td>
                                         <asp:Label ID="hospital_phoneLabel" runat="server" Text='<%# Eval("med_cent_phone") %>' />
                                            </td>
                                    <td>
                                        <h4>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="hospital_addressLabel" runat="server" Text='<%# Eval("med_cent_address") %>' />
                                           </td>
                                    <td>
                                        <h4>
                                ...
                                <tr>
                                    <td>
                                          <asp:Label ID="hospital_linkLabel" runat="server" Text='<%# Eval("med_cent_link") %>' />
                                          </td>
                                    <td>
                                        <h4>
 <asp:Label ID="Label4" runat="server" Text="الموقع"></asp:Label>
                   ...
                   <tr>
                                    <td>
            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-primary btn-md" NavigateUrl='<%# "map.aspx?lat="+Eval("med_cent_lat")+"&lng="+Eval("med_cent_lng")+"&address="+Eval("med_cent_address")+"&name="+Eval("med_cent__name")+"&phone="+Eval("med_cent_phone") %>'>الخريطة</asp:HyperLink>
       ...
       <div class="col-lg-4 col-md-4 col-sm-4 col-12 col-xs-12">
           <div class="resultImg">
                <asp:Image ID="Image1" runat="server"  style="width:260px" ImageUrl='<%# Eval("_logo_image") %>' />
           </div>
