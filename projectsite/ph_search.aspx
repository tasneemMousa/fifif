<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeFile="ph_search.aspx.cs" Inherits="ph_search" %>
<!DOCTYPE html>
...
<body>
    ...
    <asp:DropDownList ID="DropDownList1" runat="server" Height="22px" CssClass="form-control form-control-md" AutoPostBack="True" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged">
        </asp:DropDownList>
        ...
        <asp:DropDownList ID="DropDownList2" runat="server" DataTextField="zone_name" DataValueField="zone_name" CssClass="form-control form-control-md" Style="margin-top: 0">
        </asp:DropDownList>
               <span class="h2" style="padding-left: 10px; margin-top: 0">المنطقة</span><br />
                                                                                                                                                                                                                                                                                                                                                                                                                                                            
    <asp:Button ID="Button1" runat="server" OnClick="Button1_Click1" CssClass="btn btn-primary btn-md" Text="بحث" />
     </div>
        </div>
        <div class="results">
    ...
    <asp:DataList ID="DataList1" runat="server" RepeatDirection="Horizontal" RepeatColumns="4">
            <ItemTemplate>
                <table class="table">
                                <tr>
                                    <td>
<asp:Label ID="hospital_nameLabel" runat="server" Text='<%# Eval("pharm_name") %>' />
                                        </td>
                                    <td>
                                        <h4>
                                ...
                                <tr>
                                    <td>
                                         <asp:Label ID="hospital_phoneLabel" runat="server" Text='<%# Eval("pharm_phone") %>' />
                                 </td>
                                    <td>
                                        <h4>
                            <asp:Label ID="Label3" runat="server" Text="التليفون "></asp:Label>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="hospital_addressLabel" runat="server" Text='<%# Eval("pharm_address") %>' />
                                            </td>
                                    <td>
                                        <h4>
                                ...
                                <tr>
                                    <td>
                                        <asp:Label ID="hospital_linkLabel" runat="server" Text='<%# Eval("pharm_link") %>' />
                                          </td>
                                    <td>
                                        <h4>
                   ...
                   <tr>
                                    <td>
            <asp:HyperLink ID="HyperLink1" runat="server" CssClass="btn btn-primary btn-md" NavigateUrl='<%# "map.aspx?lat="+Eval("pharm_lat")+"&lng="+Eval("pharm_lng")+"&address="+Eval("pharm_address")+"&name="+Eval("pharm_name")+"&phone="+Eval("pharm_phone") %>'>الخريطة</asp:HyperLink>
       ...
       <div class="col-lg-4 col-md-4 col-sm-4 col-12 col-xs-12">
           <div class="resultImg">
                 <asp:Image ID="Image1" runat="server"  ImageUrl='<%# Eval("pharm_logo_img") %>' />
           </div>
